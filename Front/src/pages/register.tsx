  ...
  return (
		<div className="flex items-center justify-center min-h-screen bg-[url('/assets/images/forest.png')]">
			<div className="px-8 py-6 mt-7 text-left bg-white shadow-2xl md:rounded-3xl">
				<h3 className="text-2xl font-medium text-center">S'inscrire</h3>
				<form onSubmit={handleSubmit}>
					<div className="mt-7">
						<div>
							<label className="block" htmlFor="email">Nom</label>
							<input name="name" type="text" placeholder='Nom' onChange={handleChange} className="w-full px-4 py-2 mt-2 border rounded-full focus:outline-none focus:ring-1 focus:ring-green"/>
						</div>
						<div className="mt-4">
